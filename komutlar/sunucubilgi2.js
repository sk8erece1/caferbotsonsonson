...
exports.run = (client, message, args) => {
	...
	const embed = new Discord.RichEmbed()
		...
		.addField(`Emoji Sayısı `, `/emojiler yazarak sunucudaki bütün emojileri görüntüleyebilirsiniz.`)
		.addField(`Rol Sayısı `, `/roller yazarak sunucudaki bütün rolleri görüntüleyebilirsiniz.`)
